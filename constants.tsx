 ...
 */
export const ABOUT_TEXT = `I live in the messy overlap between code and people. Support tickets? Sure. But what I really do is translate the technical chaos that makes engineers' heads spin into something a normal human can actually understand. I fix bugs. When I have to. But honestly, I'm more interested in why they happened in the first place. My brain works like a developer's. Precise. Logical. Maybe a little obsessive. But I can also step back and ask: what does this actually feel like for the person using it? That's the part most people miss. I don't just connect backend logic to frontend users. I connect the why to the what. That makes all the difference. Especially when you're debugging a workflow or untangling a system that's been broken for weeks.`;
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    type: 'tech',
    description: [
      "I co-built the analysis engine for a full-stack code comprehension tool. Serverless functions on the backend. The tricky part was the prompt architecture for the Generative API. Had to use responseSchema to force structured JSON output. Then parse the model's 'thought stream' in real time so the UI wouldn't just sit there spinning.",
      ...
      "Planned and created brand content for Facebook and Instagram. It wasn't just posting. I had to actually think about what would resonate with the audience.",
  ...
  },
  {
    ...
    type: 'tech',
    description: [
      "I sold computer parts and accessories. Not fancy. But.. yeahh the real skill was making sure everything actually worked together. RAM compatibility, PSU wattage, that kind of thing. Customers appreciated not having to deal with a return.",
...
export const PROJECTS: Project[] = [
  {
    title: "Sxentrie Code Review",
    description: "A code analysis tool that uses Generative AI to scan GitHub repos and prvide Code documentation. Fast. Built on a serverless RAG architecture. I didn't want to deal with maintaining servers.",
    tags: ["Gen API", "React", "TypeScript", "RAG"],
    type: "system",
    date: "2025.06",
    demoUrl: "https://sxientrie.github.io/Sxentrie-RAG/",
    longDescription: "Sxentrie is a web-based tool that helps developers understand GitHub repositories without reading every single file. It's basically a specialized RAG system—retrieval-augmented generation—that uses the Generative model to run static analysis and generate docs on demand. The goal was speed and clarity. It helps me understand the code",
    architecture: [
    ...
    features: [
      ...
      "Multi-Model Logic: Toggles between Gemini Flash (Speed) and Gemini Pro (Reasoning).",
  ...
  },
  {
    ...
    features: [
      ...
      "Glassmorphism UI. Tuned for speed.",
  ...
  },
  {
    ...
    features: [
      "Real-time polling: Checks Reddit every 15-30 seconds for new posts. Highlights matched keywords in titles, body text, and flairs.",
      "AI draft generator: Writes replies and DMs using LLM. that need human review so it doesn't sound like AI.",
      ...
      "and so manymore.. you can checkit out it free and open"
    ]
  },
];
